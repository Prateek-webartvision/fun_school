        ...
        return Container(
          constraints: BoxConstraints(
              maxHeight: context.screenHeight -
                  rootNavigator.currentContext!.viewPadding.top),
          color: Colors.white,
          child: Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: GestureDetector(
                          ...
                          child:
                              SizedBox(height: 48, child: Icon(Icons.close))),
                    ),
                    Align(
                  ...
                  itemBuilder: (context, index) {
                    return GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          border: Border.all(
                              color: (studyPlanSelector
                                          .selectedPlan?.studyPlanId !=
                                      widget.myStudyPlan[index].studyPlanId)
              ...
              GestureDetector(
                onTap: () {
                  if (studyPlanSelector.selectedPlan != null) {
                    rootNavigator.currentState!
                        .pop(studyPlanSelector.selectedPlan!.title ?? "");
                  }
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(8)),
                  margin:
                      EdgeInsets.symmetric(horizontal: 16).copyWith(bottom: 10),
                  alignment: Alignment.center,
                  child: Text(
                    "add to".toUpperCase(),
                    style: TextStyle(
